export const home = {
  hero: {
    ...
    alt2: "Fleche blanche",
    alt3: "Deux téléphone, décrivant l'application teamdoc",
  },
  simplification: {
    h2: "Simplifions le quotidien des soignants",
    p1: "Team’Doc est un outil de travail collaboratif qui permet d’échanger des informations sur les patients en toute sécurité. Communiquez en temps réel avec votre équipe, créez ou rejoignez un réseau de professionnels de santé.",
    h3: "Messagerie instantanée sécurisée de santé",
    p2: "Développé sous forme d’application sécurisée Team’Doc intègre les outils du quotidien : Whatsapp® médical sécurisé et Dropbox® de la santé.",
    alt: "Image qui montre du personnel soignants",
  },
  functionnalities: {
    h2: "Les fonctionnalités de l’application",
    p: "Une solution sécurisée avec des fonctionnalités simples et interactives.",
    alt: "Image d'un téléphone montrant l'application teamdoc",
  },
  functionnalityLeft: {
    h3_1: "Communication 100% sécurisée",
    p1: "Échangez des informations, photos et vidéos par la messagerie instantanée sécurisée.",
    alt1: "Logo communication",
    h3_2: "Cloud sécurisé",
    p2: "Stockez et partagez des médias et documents et partagez-les avec votre équipe ou d’autres professionnels de santé.",
    alt2: "Logo cloud sécurisé",
    h3_3: "Fiches de transmission numériques",
    p3: "Remplissez des fiches de transmissions préformatées de votre choix pour gagner du temps et éviter de perdre des informations.",
    alt3: "Logo fiche de transmission",
  },
  functionnalityRight: {
    h3_1: "Réseau de professionnels",
    p1: "Échangez avec vos contacts ou avec d’autres professionnels en créant différents réseaux (mon cabinet, mon équipe à l’hôpital)",
    alt1: "Logo réseau professionnel",
    h3_2: "Droit à la déconnexion",
    p2: "Indiquez votre statut (disponible, occupé, indisponible). Retrouvez facilement les personnes disponibles (de garde, d’astreinte, d’avis).",
    alt2: "Logo droit à la déconnexion",
    h3_3: "Tâches planifiées",
    p3: "Assurez la coordination des soins ou un suivi particulier d’un patient en créant vos tâches.",
    alt3: "Logo tâche",
  },
  recommandations: {
    citation1:
