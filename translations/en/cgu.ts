export const cgu = {
  ...
  article12: {
    ...
    texte5:
      "USERS' Personal Data will not be disclosed to third parties and will be kept under the conditions and for the duration strictly necessary for the purposes set out in ",
    privacy: "the privacy Policy.",
    texte6:
      "Data subjects have rights, as set out in the privacy Policy, and may exercise their rights by sending an e-mail to the following address, ",
    ...
    texte10:
      "12.5. Deletion of data - The USER is warned that the data contained in his PROFILE will be deleted in the event of complete inactivity of his PROFILE, characterized by a total absence of connection for an uninterrupted period of one year. ",
    texte10strong: " Thirty (30) days",
    texte10bis:
      " before the definitive deletion of his PROFILE, the USER will receive a notification informing him that his PROFILE is considered inactive and the consequences of this inactivity.",
    texte11:
