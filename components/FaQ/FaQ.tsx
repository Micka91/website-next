...
const FaQ = () => {
  ...
  const questions = [
    {
      id: 2,
      title: faq.questions.two.title,
      paragraph: faq.questions.two.paragraph,
      paragraph2: faq.questions.two.paragraph2,
      link: "https://www.teamdoc.fr/securite",
      linkText: faq.questions.two.link,
    },
  ];
  ...
  const questions2 = [
    {
      id: 4,
      title: faq.questions.three.title,
      paragraph: faq.questions.three.paragraph,
      paragraph2: faq.questions.three.paragraph2,
      link: "mailto:support@teamdoc.fr",
      linkText: faq.questions.three.support_link,
    },
    {
      id: 3,
      title: faq.questions.one.title,
      paragraph: faq.questions.one.paragraph,
